...
var listImgItem = [
    {
        id: 1,
        img: [
            './img/product/20-copy-600x745.jpg',
            './img/product/20_1-copy-600x745.jpg',
        ],
    },
    {
        id: 2,
        img: [
            './img/product/3_1-600x745.jpg',
    ...
    },
    {
        id: 3,
        img: [
            './img/product/10_1-copy-600x745.jpg',
    ...
    },
    {
        id: 4,
        img: [
            './img/product/9-copy-600x745.jpg',
    ...
    },
    {
        id: 6,
        img: [
            './img/product/8_1-copy-600x745.jpg',
    ...
    },
    {
        id: 7,
        img: [
            './img/product/17_1-copy-600x745.jpg',
            './img/product/17-copy-600x745.jpg',
        ],
    },
    {
        id: 8,
    ...
    },
    {
        id: 9,
        img: [
            './img/product/19_1-copy-600x745.jpg',
            './img/product/19_2-copy-600x745.jpg',
        ],
    },
    {
        id: 10,
        img: [
            './img/product/12-copy-600x745.jpg',
            './img/product/12_2-copy-600x745.jpg',
        ],
    },
    {
        id: 11,
        img: [
            './img/product/22_1-copy-600x745.jpg',
            './img/product/21-copy-600x745.jpg',
        ],
    },
    {
        id: 12,
        img: [
            './img/product/7_1-copy-600x745.jpg',
    ...
    },
    {
        id: 13,
        img: [
            './img/product/2_1-copy-600x745.jpg',
            ...
            owl.trigger('add.owl.carousel', [
                ...
                <div class="item">
                    <div class="product" data-id = ${val.id} >
                        <div class="img">
                            <a href="#" onclick ="return changeUrlDetail(${
                                val.id
                            })">
                                <img src="${val.img}" alt="">
